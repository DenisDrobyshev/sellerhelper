...
SellerHelper фиксирует эту экспертизу в виде последовательности ворот. Каждая стадия вычисляет метрики по собранным карточкам и применяет явное условие прохождения. Не прошедшая стадия останавливает конвейер и сообщает числа, на которых основано решение.
